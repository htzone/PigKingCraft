...
if GetModConfigData("language") == "chinese" then
	...
	GLOBAL.PKC_SPEECH = {
		...
		ANNOUNCE_SPEECH = {
			"猪王争霸小贴士：如果为PVP模式，击杀对面的猪王或是赢得足够高的分数都可以获得比赛的胜利！",
			"猪王争霸小贴士：按Shift键可以短暂冲刺，按C键可以回城，请善用这两点！",
			"猪王争霸小贴士：按Y键队伍内聊天，按U键所有人聊天！",
			"猪王争霸小贴士：按Y键输入 '#投降' 或 '#sur' 可以发起投降，达到投降最低人数即可投降成功!",
			"猪王争霸小贴士：通过路牌传送可以很快到达到同组路牌或玩家的附近，减少跑路时间！",
			"猪王争霸小贴士：善待猪人，猪人们或许能成为你的好帮手！",
			"猪王争霸小贴士：分组生存对抗，最后剩下的阵营将会是比赛的胜利者！",
			"猪王争霸小贴士：按Y键输入 '#投降' 或 '#sur' 可以发起投降，达到投降最低人数即可成功投降!",
		},
		SURRENDER_SPEECH = {
			SPEECH1 = "#投降",
