...
local function fn()
    ...
    inst.components.named:SetName("野猪图腾")
    ...
    inst.components.spawner:Configure("pkc_pigguard", TUNING.TOTAL_DAY_TIME * 1, 0)
...
return Prefab("pkc_pigtorch", fn, assets, prefabs)
