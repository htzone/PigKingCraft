...
----[[声明全局变量]]----
	...
	if GLOBAL.GAME_LANGUAGE == "chinese" then
		...
		GLOBAL.STRINGS.RECIPE_DESC.PKC_EWECUSHAT = "高贵身份的象征，能让猪人跟随你."
		...
		GLOBAL.STRINGS.RECIPE_DESC.PKC_BIRCHNUTHAT = "高贵身份的象征，能让猪人跟随你."
		...
		GLOBAL.STRINGS.RECIPE_DESC.PKC_SUMMERBANDANA = "高贵身份的象征，能让猪人跟随你."
