...
----[[声明全局变量]]----
	...
	if GLOBAL.GAME_LANGUAGE == "chinese" then
		...
		GLOBAL.STRINGS.NAMES.SPARTAHELMUT = "红色骑士头盔"
		GLOBAL.STRINGS.RECIPE_DESC.SPARTAHELMUT = "拥有高贵身份的象征，同时也拥有不错的防御力."
		GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WILLOW.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WOLFGANG.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WENDY.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WX78.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WICKERBOTTOM.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WOODIE.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WAXWELL.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WATHGRITHR.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		GLOBAL.STRINGS.CHARACTERS.WEBBER.DESCRIBE.SPARTAHELMUT = "那是红色军团的头盔."
		...
		GLOBAL.STRINGS.NAMES.SPARTAHELMUT = "Golden Helmet"
		GLOBAL.STRINGS.RECIPE_DESC.SPARTAHELMUT = "Expensive armor piece."
		GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.SPARTAHELMUT = "Its design seems ancient."
		GLOBAL.STRINGS.CHARACTERS.WILLOW.DESCRIBE.SPARTAHELMUT = "That tuft is fluffy and red like fire!"
		GLOBAL.STRINGS.CHARACTERS.WOLFGANG.DESCRIBE.SPARTAHELMUT = "Is kind of dumb look."
		GLOBAL.STRINGS.CHARACTERS.WENDY.DESCRIBE.SPARTAHELMUT = "It's worth more than my life."
		GLOBAL.STRINGS.CHARACTERS.WX78.DESCRIBE.SPARTAHELMUT = "METAL HELMET WITH ATTACHED FLESHLING BODY PARTS"
		GLOBAL.STRINGS.CHARACTERS.WICKERBOTTOM.DESCRIBE.SPARTAHELMUT = "A Spartan-esque helmet made of gold."
		GLOBAL.STRINGS.CHARACTERS.WOODIE.DESCRIBE.SPARTAHELMUT = "That is not a Canadian helmet."
		GLOBAL.STRINGS.CHARACTERS.WAXWELL.DESCRIBE.SPARTAHELMUT = "Looks classy."
		GLOBAL.STRINGS.CHARACTERS.WATHGRITHR.DESCRIBE.SPARTAHELMUT = "It's gold but lacks an unicorn!"
		GLOBAL.STRINGS.CHARACTERS.WEBBER.DESCRIBE.SPARTAHELMUT = "Three hundred or less... We will fight!"
