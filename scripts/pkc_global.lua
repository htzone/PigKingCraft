...
----[[声明全局变量]]----
	...
	--复活无敌时间（秒）
	GLOBAL.PKC_REVIVE_INVINCIBLE_TIME = 12
	--玩家死亡初始自动复活时间（秒）
	...
	--猪人守卫攻击力
	GLOBAL.TUNING.PIG_GUARD_DAMAGE = 35
	--猪人守卫据点每次安置的数目
	GLOBAL.PIG_GUARD_PER_POINT_NUM = 30
	--猪人守卫最大数目
	GLOBAL.PIG_GUARD_MAX_POINT_NUM = 250

	--鱼人boss相关
	GLOBAL.MERM_HEALTH = 10000 --鱼人boss生命值
